...
export const ButtonNav = styled("button")`
  ...
  font-size: 18px;
  font-weight: 500;
  background: ${(props) => (props.white ? "#fff" : "#fcdd06")};
...
export const SearchWrap = styled(FlexRow)`
@media screen and (max-width: 1100px) {
  display: none;
}
`
export const SearcMobilehWrap = styled(FlexRow)`
margin-top: 20px;
background-color: #fff;

`

export const ButtonMobileNav = styled(ButtonNav)`
background-color:#fff;
`